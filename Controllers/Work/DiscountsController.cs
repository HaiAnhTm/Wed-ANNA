...
namespace DotNet_E_Commerce_Glasses_Web.Controllers.Work
{
    public class DiscountsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "IdDiscount,IdStatus,TitleDiscount,DateOfStart,DateOfEnd,Quantity,Percent,Image,CodeDiscount")] Discount discount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IdDiscount,IdStatus,TitleDiscount,DateOfStart,DateOfEnd,Quantity,Percent,Image,CodeDiscount")] Discount discount)
        {
            if (ModelState.IsValid)
            {
